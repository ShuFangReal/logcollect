...
public class MyUDF extends UDF {
    public String evaluate(String json, String keys) {
        ...
        try {
            ...
            JSONObject jsonContent = new JSONObject(realJson);

            JSONObject cm = jsonContent.getJSONObject("cm");
            ...
            sb.append(jsonContent.getString("et")).append("\t");
            sb.append(servertime).append("\t");
    ...
    public static void main(String[] args) {
        ...
        String evaluate = myUDF.evaluate(line, "mid,uid,vc,vn,l,sr,os,ar,md,ba,sv,g,hw,nw,ln,la,t");
